...
# Configuração da Label, acima do input.
...
def _display_control_a(event):
    ...
    return 'break'   # É orientação da própria documentação


# 1 Configurando os botões da calculadora:
# 1.1 Criando uma lista de listas dos botões
...
# 1.2 Criando a Grid de botões colunas x linhas 
